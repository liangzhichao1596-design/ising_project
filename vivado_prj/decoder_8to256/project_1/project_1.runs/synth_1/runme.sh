...
HD_PWD='E:/zcling/ising_project/vivado_prj/decoder_prj/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_8to256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_8to256.tcl
