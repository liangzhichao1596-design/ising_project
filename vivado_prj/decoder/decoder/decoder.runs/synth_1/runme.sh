...
HD_PWD='E:/zcling/ising_project/WEEK4_10/decoder/decoder/decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log large_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source large_decoder.tcl
